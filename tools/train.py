...
def parse_config():
    ...
    print(cfg)  # 전체 설정 출력
    print("DEBUG: Checking if OPTIMIZATION exists")
    print(cfg.get("OPTIMIZATION", "NOT FOUND"))
...
def main():
    ...
    output_dir = cfg.ROOT_DIR / '' / cfg.EXP_GROUP_PATH / cfg.TAG / args.extra_tag
    ...
    print("DEBUG: Checking if DATA_CONFIG exists in cfg")
    print(cfg.get("DATA_CONFIG", "NOT FOUND"))

    if "DATA_CONFIG" not in cfg:
        raise KeyError("ERROR: DATA_CONFIG section is missing from the config file!")
